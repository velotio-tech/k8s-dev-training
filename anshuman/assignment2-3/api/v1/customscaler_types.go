...
type CustomScalerSpec struct {
	...
	// The image name that will be used
...
const (
	Uninitialized ScalerState = "Uninitialized"
	Created       ScalerState = "Created"
	Error         ScalerState = "Error"
)
...
type CustomScalerStatus struct {
	...
	State ScalerState `json:"scalerstate"`
}
