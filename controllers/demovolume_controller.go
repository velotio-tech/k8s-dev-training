...
//+kubebuilder:rbac:groups=demo.domo.civo.io,resources=demovolumes,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=demo.domo.civo.io,resources=demovolumes/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=demo.domo.civo.io,resources=demovolumes/finalizers,verbs=update
