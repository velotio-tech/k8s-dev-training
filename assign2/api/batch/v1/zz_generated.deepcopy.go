...
func (in *BookSpec) DeepCopyInto(out *BookSpec) {
	*out = *in
	in.PublishDate.DeepCopyInto(&out.PublishDate)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReferenceGVK) DeepCopyInto(out *ReferenceGVK) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReferenceGVK.
func (in *ReferenceGVK) DeepCopy() *ReferenceGVK {
	if in == nil {
		return nil
	}
	out := new(ReferenceGVK)
	in.DeepCopyInto(out)
	return out
}
